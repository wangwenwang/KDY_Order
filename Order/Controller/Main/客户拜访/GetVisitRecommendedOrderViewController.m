...
@interface GetVisitRecommendedOrderViewController ()<GetVisitEnterShopServiceDelegate, SelectGoodsServiceDelegate, GetOutProductTypeServiceDelegate, Store_GetOutProductListServiceDelegate, Store_GetOupputListServiceDelegate>
